...
\newpage
\begin{table}[h!]
\caption{Results for Magnitude Output for Delay equal to One}
\begin{tabular}{c}
 ...
 \end{table}
\begin{table}[h!]
\caption{Results for Frequency Output for Delay equal to One}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Magnitude Output for Instant Delay equal to Two}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Frequency Output for Instant Delay equal to Two}
\begin{tabular}{c}
...
\newpage 
\begin{table}[h!]
\caption{Results for Angle Output for Instant Delay equal to Two}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Magnitude Output for Instant Delay equal to Three}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Frequency Output for Instant Delay equal to Three}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Angle Output for Instant Delay equal to Three}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Magnitude Output for Instant Delay equal to Four}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Frequency Output for Instant Delay equal to Four}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Angle Output for Instant Delay equal to Four}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Magnitude Output for Instant Delay equal to Five}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Frequency Output for Instant Delay equal to Five}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Angle Output for Instant Delay equal to Five}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Magnitude Output for Instant Delay equal to Six}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Frequency Output for Instant Delay equal to Six}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Angle Output for Instant Delay equal to Six}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Angle Output for Step-Wise Delay equal to Two}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Magnitude Output for Step-Wise Delay equal to Three}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Frequency Output for Step-Wise Delay equal to Three}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Angle Output for Step-Wise Delay equal to Three}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Magnitude Output for Step-Wise Delay equal to Four}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Frequency Output for Step-Wise Delay equal to Four}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Angle Output for Step-Wise Delay equal to Four}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Magnitude Output for Step-Wise Delay equal to Five}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Frequency Output for Step-Wise Delay equal to Five}
\begin{tabular}{c}
...
\begin{table}[h!]
\caption{Results for Angle Output for Step-Wise Delay equal to Six}
\begin{tabular}{c}
