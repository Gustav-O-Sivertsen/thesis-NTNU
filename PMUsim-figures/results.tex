...
\begin{floatingfigure}[p]{\textwidth}
   \tcbox[size=small, standard jigsaw, opacityback=0, boxrule=0pt,halign=justify]{\fontsize{12}{15} \textbf{Results for Frequency Output}}{
...
\begin{floatingfigure}[p]{\textwidth}
     \tcbox[size=small, standard jigsaw, opacityback=0, boxrule=0pt,halign=justify]{\fontsize{12}{15} \textbf{Results for Angle Output}}{
     \begin{small}
...
\begin{floatingfigure}[p]{\textwidth}[bp]
     \tcbox[size=small, standard jigsaw, opacityback=0, boxrule=0pt,halign=justify]{\fontsize{12}{15} \textbf{Results for Magnitude Output}}{
     \begin{small}
