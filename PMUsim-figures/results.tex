...
\begin{table}[h]
\caption{Results for Magnitude Output for Step_wise Delay equal to Two}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Frequency Output for Step_wise Delay equal to Two}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Angle Output for Step_wise Delay equal to Two}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Magnitude Output for Step_wise Delay equal to Three}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Frequency Output for Step_wise Delay equal to Three}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Angle Output for Step_wise Delay equal to Three}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Magnitude Output for Step_wise Delay equal to Four}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Frequency Output for Step_wise Delay equal to Four}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Angle Output for Step_wise Delay equal to Four}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Magnitude Output for Step_wise Delay equal to Five}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Frequency Output for Step_wise Delay equal to Five}
\begin{tabular}{c}
...
\begin{table}[h]
\caption{Results for Angle Output for Step_wise Delay equal to Five}
\begin{tabular}{c} 
...
\begin{table}[h]
\caption{Results for Magnitude Output} for Step_wise Delay equal to Six
\begin{tabular}{c} 
...
\begin{table}[h]
\caption{Results for Frequency Output for Step_wise Delay equal to Six}
\begin{tabular}{c} 
...
\begin{table}[h]
\caption{Results for Angle Output for Step_wise Delay equal to Six}
\begin{tabular}{c}
