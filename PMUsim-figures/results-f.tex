...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_0/Zero_vMagnitude.eps}} \\ 
   
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_0/Zero_vFrequency.eps}} \\ 

   \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_0/Zero_vAngle.eps}} 
...
\begin{figure}[H]
\begin{tabular}{c}
    \fbox{ \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_0/Zero_iMagnitude.eps}} \\
	
       \fbox{ \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_0/Zero_iFrequency.eps}}  \\
	   
   \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_0/Zero_iAngle.eps}} \\ 
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_1/Instant_vMagnitude.eps}} \\ 
   \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_1/Instant_vAngle.eps}} \\   
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_1/Instant_vFrequency.eps}}
...
\label{fig:VoltageInstantDelayOne}
          ...
          Similar, but mirrored, spikes are apparent for angle and frequency. \\ 
           A constant shift of angle, possibly $120^0$, is apparent, whereas the other components, magnitude and frequency, shows no constant alteration of value.
          \end{tabular} }
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_1/Instant_iMagnitude.eps}} \\ 
    \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_1/Instant_iAngle.eps}} \\   
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_1/Instant_iFrequency.eps}}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Instant_vMagnitude.eps}} \\ 
    \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Instant_vAngle.eps}} \\  
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Instant_vFrequency.eps}}
...
\label{fig:VoltageInstantDelayTwo}
          ...
          Similar, but mirrored, spikes are apparent for the frequency, whereas the spikes for angle differs.\\ 
           A constant shift of angle, possibly $-120^0$, is apparent, whereas the magnitude and frequency shows no constant alteration of value during the main period of the attack.
          \end{tabular} }
\end{figure}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Instant_iMagnitude.eps}} \\ 
    \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Instant_iAngle.eps}} \\   
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Instant_iFrequency.eps}}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_3/Instant_vMagnitude.eps}} \\ 
   \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_3/Instant_vAngle.eps}} \\    
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_3/Instant_vFrequency.eps}}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_3/Instant_iMagnitude.eps}} \\ 
   \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_3/Instant_iAngle.eps}} \\    
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_3/Instant_iFrequency.eps}}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_4/Instant_vMagnitude.eps}} \\ 
  \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_4/Instant_vAngle.eps}} \\   
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_4/Instant_vFrequency.eps}} 
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_4/Instant_iMagnitude.eps}} \\ 
   \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_4/Instant_iAngle.eps}} \\    
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_4/Instant_iFrequency.eps}}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_5/Instant_vMagnitude.eps}} \\ 
    \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_5/Instant_vAngle.eps}} \\   
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_5/Instant_vFrequency.eps}}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_5/Instant_iMagnitude.eps}} \\ 
    \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_5/Instant_iAngle.eps}} \\  
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_5/Instant_iFrequency.eps}}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_6/Instant_vMagnitude.eps}} \\ 
   \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_6/Instant_vAngle.eps}} \\   
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_6/Instant_vFrequency.eps}}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_6/Instant_iMagnitude.eps}} \\ 
   \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_6/Instant_iAngle.eps}} \\   
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_6/Instant_iFrequency.eps}}
...
\begin{itemize}
\ìtem  What are the effects of repetitive increases of the delay level by one for different number of repetitions?
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Step_vMagnitude.eps}} \\ 
    \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Step_vAngle.eps}} \\ 
  
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Step_vFrequency.eps}}
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Step_iMagnitude.eps}} \\ 
   \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Step_iAngle.eps}} \\   
   \fbox{    \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_2/Step_iFrequency.eps}} 
...
\begin{figure}[H]
\begin{tabular}{c}
  \fbox{  \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_3/Step_vMagnitude.eps}} \\ 
   \fbox{     \includegraphics[width=0.95\textwidth]{PMUsim-figures/DelayOf_3/Step_vAngle.eps}} \\    
